...
import 'package:medicine_reminder/src/Reminder_ui/medicine_details/medicine_details.dart';
import 'package:medicine_reminder/src/Reminder_ui/new_entry/new_entry.dart';
import 'package:medicine_reminder/src/constants.dart';
import 'package:medicine_reminder/src/global_bloc.dart';
import 'package:medicine_reminder/src/models/medicine.dart';

import 'package:provider/provider.dart';

class HomePageReminder extends StatefulWidget {
  @override
  _HomePageReminderState createState() => _HomePageReminderState();
}

class _HomePageReminderState extends State<HomePageReminder> {
  void initState() {
    super.initState();
  }
                  ...
                  child: Text(
                    !snapshot.hasData
                        ...
                        : snapshot.data.length
                            .toString(), //this is to display number of reminders
                    style: TextStyle(
                      fontFamily: "Neu",
                      fontSize: 28,
...
//This function is used to display the cards,that is to display reminders in the home page
class MedicineCard extends StatelessWidget {
  ...
  Hero makeIcon(double size) {
    //medicineType is defined in the page models/medicine_type.dart
